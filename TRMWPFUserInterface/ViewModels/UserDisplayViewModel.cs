...
namespace TRMDesktopUI.ViewModels
{
    public class UserDisplayViewModel : Screen
    {
        ...
        /// <summary>
        /// Loads the roles that the current user doesnt have.
        /// Meaning the roles that can be added to him.
        /// </summary>
        private async Task LoadRoles()
        {
            ...
            {
                // if the current user doesn't have the role I'm iterrating at add it
